...
public class CoalitionPage extends PageObject {
...
//SUPER DRIVER
    ...
    public CoalitionPage(WebDriver driver) {
        super(driver);
    }

//OPERATIONS

    public void consultationFormWait() {
    ...
    public void numerationOfBlocks() {
        ...
        for (int i = 0; i < classesOfBlocks.length; i++) {
            ...
            assertEquals(curBlockContent, numerationOfBlocks[i], "!Нумерация блоков на страенице больше или меньше 1!");
        }
    }
}
